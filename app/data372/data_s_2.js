    ...
    var desc = {
        ...
        data = [
			...
			{ // problem 5
                ...
                formula: 'C = &pi; <font size = 4>&bull;</font> d',
				substitution: 'C = 3.14 <font size = 4>&bull;</font> 20',
				lineOneSolve: 'C = 62.8',
			...
			{ // problem 6
				...
				identifyShape: 'Circle',
                formula: 'C = &pi; <font size = 4>&bull;</font> d',
                substitution: 'C = 3.14 <font size = 4>&bull;</font> 32',
				lineOneSolve: 'C = 100.48',
			...
			{ // problem 7
				...
				unitsSelect: '[\\"m\\",\\"m&sup2;\\",\\"m&sup3;\\"]',
				identifyShape: 'Circle',
                formula: 'C = &pi; <font size = 4>&bull;</font> 2r',
                substitution: 'C = 3.14 <font size = 4>&bull;</font> 2 (18)',
				lineOneSolve: 'C = 113.04',
			...
			{ // problem 8
				...
				identifyShape: 'Circle',
                formula: 'C = &pi; <font size = 4>&bull;</font> 2r',
                substitution: 'C = 3.14 <font size = 4>&bull;</font> 2 (8)',
				lineOneSolve: 'C = 50.24',
			...
			{ // problem 9
				...
				identifyShape: 'Circle',
                formula: 'C = &pi; <font size = 4>&bull;</font> d',
                substitution: 'C = 3.14 <font size = 4>&bull;</font> 6.3',
				lineOneSolve: 'C = 19.782',
			...
			{ // problem 10
				...
				identifyShape: 'Circle',
                formula: 'C = &pi; <font size = 4>&bull;</font> 2r',
                substitution: 'C = 3.14 <font size = 4>&bull;</font> 2 (13.09)',
				lineOneSolve: 'C = 82.2052',
			...
			{ // problem 11
				...
				identifyShape: 'Circle',
                formula: 'C = &pi; <font size = 4>&bull;</font> 2r',
				substitution: 'C = <sup>22</sup>&#8260;<sub>7</sub> <font size = 4>&bull;</font> 2 ( 6 <sup>1</sup>&#8260;<sub>2</sub> )',
				lineOneSolve: 'C = 40 <sup>6</sup>&#8260;<sub>7</sub> ',
				desc: '',
			...
			{ // problem 12
				...
				identifyShape: 'Circle',
                formula: 'C = &pi; <font size = 4>&bull;</font> 2r',
				substitution: 'C = <sup>22</sup>&#8260;<sub>7</sub> <font size = 4>&bull;</font> 2 ( 3 <sup>1</sup>&#8260;<sub>3</sub> )',
				lineOneSolve: 'C = 20 <sup>20</sup>&#8260;<sub>21</sub> ',
				desc: '',
			...
			{ // problem 13
				...
				identifyShape: 'Circle',
                formula: 'C = &pi; <font size = 4>&bull;</font> d',
				substitution: 'C = <sup>22</sup>&#8260;<sub>7</sub> <font size = 4>&bull;</font> 8 <sup>2</sup>&#8260;<sub>5</sub>',
				lineOneSolve: 'C = 26 <sup>2</sup>&#8260;<sub>5</sub> ',
				desc: '',
			...
			{ // problem 14
				...
				identifyShape: 'Circle',
                formula: 'C = &pi; <font size = 4>&bull;</font> d',
				substitution: 'C = <sup>22</sup>&#8260;<sub>7</sub> <font size = 4>&bull;</font> 4 <sup>1</sup>&#8260;<sub>2</sub>',
				lineOneSolve: 'C = 14 <sup>1</sup>&#8260;<sub>7</sub> ',
				desc: '',
			...
			{ // problem 15
				questionDesc: dataUtils.pre('\\html{Solve for the circumference. <br>Use <sup>22</sup>/<sub>7</sub> for &pi;. Give the answer as a mixed number.}'),
				illustration: 'S.2/Circle_r_8_2-5cm.jpg',
				unitsAnswer: 'cm',
				unitsPower: 'cm',
				unitsSelect: '[\\"cm\\",\\"cm&sup2;\\",\\"cm&sup3;\\"]',
				identifyShape: 'Circle',
                formula: 'C = &pi; <font size = 4>&bull;</font> 2r',
				substitution: 'C = <sup>22</sup>&#8260;<sub>7</sub> <font size = 4>&bull;</font> 2 (8 <sup>2</sup>&#8260;<sub>5</sub> )',
				lineOneSolve: 'C = 52 <sup>4</sup>&#8260;<sub>5</sub> ',
				desc: '',
