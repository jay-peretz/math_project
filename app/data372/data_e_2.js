...
angular.module('mathSkills').service('data_e_2', ['dataUtils', function (dataUtils) {
    var desc = {
                ...
                children: [{
                    ...
                    children: [{
                        problem: '\\grp'
									...
									+'{\\sign{&times;}}'
									+'{\\mixed{\\fracstr{$m2}}{\\frac{\\fracstr{$n2}}{\\fracstr{$d2}}}}',
                        answer: '\\mixed{\\input{$ma}}{\\frac{\\input{$nwa}}{\\input{$dwa}}}',
                        controls: {
                            "checkAnswer": true,
                            "help": false,
                            "workbook": true
                    ...
                    children: [{
                        ...
                        answer: '\\css'
									+'{\\rowgrp'
										...
										+'{\\grp{\\frac{\\fracstr{$rn1}}{\\fracstr{$rd1}}}{\\sign{&times;}}{\\frac{\\fracstr{$rn2}}{\\fracstr{$rd2}}}{\\sign{=}}{\\frac{\\fracstr{$product}}{\\fracstr{$da}}}}'
										+'{\\html{&nbsp;}}'
										+'{\\ins{Write the fraction as a whole number.}}'
										+'{\\html{&nbsp;}}'
										+'{\\grp{\\frac{\\fracstr{$product}}{\\fracstr{$da}}}'
										+'{\\str{\xA0 = \xA0}}'
										+'{\\mixed{\\input{$ma}}{\\frac{\\input{$nwa}}{\\input{$dwa}}}}}'
									+'}{well}',
                        controls: {
                            "checkAnswer": true,
                            "help": true
        ...
        data = [
            ...
            { m1: 1, n1: 2, d1: 5, un1: 6, m2: 2, n2: 1, d2: 2, un2: 5, ma: 3, na: '3', product: '3', da: '1', rn1: 6, rd1:5, rn2: 5, rd2: 2, nwa: '', dwa: '', template: 'mixedWholeAns' },           
            ...
            { m1: 3, n1: 1, d1: 8, un1: 25, m2: 2, n2: 2, d2: 3, un2: 8, ma: 8, na: 1, product: '25', da: 3, rn1: 25, rd1: 8, rn2: 8, rd2: 3, template: 'mixed' },
