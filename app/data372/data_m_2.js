...
angular.module('mathSkills').service('data_m_2', ['dataUtils', function (dataUtils) {
    var desc = {
        ...
        data = [
			// problem 1
            { whole1: -2, num1: 3, den1: 5, whole2: 3, num2: 1, den2: 5, numanswer1: 3, numanswer2: 3, answerDen: 5, numnew1: -13, numnew2: 16, numlcd1: -13, numlcd2: 16, template: 'second' },
			// problem 2
			{ whole1: -1, num1: 4, den1: 5, whole2: 2, num2: 1, den2: 2,wholeanswer: '-4', numanswer1: -43, numanswer2: 3, answerDen: 10, numnew1: -9, numnew2: 5, numlcd1: -18, numlcd2: 25, template: 'main' },
			// problem 3
