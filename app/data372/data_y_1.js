...
template = {
        ...
        data = [
			...
			// problem 7
			{ firstSign: '-', secondSign: '', firstAbsNumber: '2', secondAbsNumber: '15', firstText: '/ 5', secondText: '', thirdText: 'a', fourthText: '', firstExp:'', secondExp: '<sup>2</sup>', firstLeftparan: '(', secondLeftparan: '(',firstRightparan: ')',secondRightparan: ')',firstHelp: 'When multiplying terms, multiply :', secondHelp: '(1) the coefficients together: $$firstSign $$firstAbsNumber/5 * $$secondAbsNumber = -6<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;and<br>(2) the same variable together&nbsp;( follow the exponent rule - multiplication of same bases --& and add exponents) :', thirdHelp: 'The variable <span class=underline>a</span> has no other <span class=underline>a</span> to multiply by. The a<sup>2</sup> remains a part of the multiplication (-6 * a<sup>2</sup>). ', textAnswer: ' &nbsp; -6a<sup>2</sup>', ans: '-6', firsttex:'a', firstexp: '2', template: 'fourth' },
			// problem 8
			...
			// problem 9
			{ firstSign: '-', secondSign: '', thirdSign: '-', firstAbsNumber: '', secondAbsNumber: '',thirdAbsNumber: '4', firstText: 'x', secondText: '', thirdText: 'x', fourthText: '', fifthText: 'y',sixthText: '', firstExp:'', secondExp: '<sup>2</sup>',thirdExp: '', firstLeftparan: '(', secondLeftparan: '(',firstRightparan: ')',secondRightparan: ')',thirdLeftparan: '(', thirdRightparan: ')', firstHelp: 'When multiplying terms, multiply :', secondHelp: '(1) the coefficients together: $$firstSign 1 * 1 * $$thirdSign $$thirdAbsNumber = 4 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;and<br>(2) the same variable together&nbsp;( follow the exponent rule - multiplication of same bases --& and add exponents) :<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x * x <sup>2</sup> = x<sup>3</sup> ', thirdHelp: 'The variable <span class=underline>y</span> has no other <span class=underline>y</span> to multiply by. The y remains a part of the multiplication (4 * x<sup>3</sup> * y). ',textAnswer: ' &nbsp; 4x<sup>3</sup>y', ans: '4', firsttex:'x', firstexp: '3', secondtex:'y', template: 'fifth' },
			// problem 10
			{ firstSign: '', secondSign: '-', thirdSign: '', firstAbsNumber: '4', secondAbsNumber: '2',thirdAbsNumber: '7', firstText: 'y', secondText: '', thirdText: 'x', fourthText: '', fifthText: 'x',sixthText: 'z', firstExp:'', secondExp: '',thirdExp: '<sup>3</sup>', firstLeftparan: '', secondLeftparan: '',firstRightparan: '',secondRightparan: '',thirdLeftparan: '', thirdRightparan: '', firstHelp: 'When multiplying terms, multiply :', secondHelp: '(1) the coefficients together: 4 * -2 * 7 = -56<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;and<br>(2) the same variable together&nbsp;( follow the exponent rule - multiplication of same bases --& and add exponents) :<br><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; x * x = x<sup>2</sup> ', thirdHelp: 'The variable <span class=underline>y</span> has no other <span class=underline>y</span> to multiply by. The variable <span class=underline>z</span> has no other <span class=underline>z</span> to multiply by. The y and the z remains a part of the multiplication (-56 * x<sup>2</sup> * y * z<sup>3</sup>). ', textAnswer: ' &nbsp; -56x<sup>2</sup>yz<sup>3</sup>', ans: '-56', firsttex:'x', firstexp: '2', secondtex:'y', thirdtex:'z', thirdexp: '3', template: 'sixth' },
        ];
