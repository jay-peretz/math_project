            ...
            main: {
                ...
                children: [{
                    ...
                    children: [{
                        ...
                        answer: '\\css'
                                +'{\\grp'
                                +'{\\mixed{\\str{$whole1}}{\\frac{\\str{$num1}}{\\str{$den1}}}}'
                                +'{\\sign{-}}'
                                +'{\\mixed{\\str{$whole2}}{\\frac{\\str{$num2}}{\\str{$den2}}}}'
                                +'{\\sign{=}}'
                                +'{\\mixed{\\input{$wholeanswer}}{\\frac{\\input{$numanswer}}{\\input{$denanswer}}}}}',                
                        controls: {
                            "checkAnswer": true,
                            "help": false,
                            "workbook": true
                ...
                children: [{
                    ...
                    children: [{
                        ...
                        answer: '\\css'
                                ...
                                +'{\\mixed{\\str{$whole2}}{\\frac{\\str{$num2}}{\\str{$den2}}}}'
                                +'{\\sign{=}}'
                                +'{\\mixed{\\input{$wholeanswer}}{\\frac{\\input{$numanswer2}}{\\input{$denanswer2}}}}}',
                         controls: {
                            "checkAnswer": true,
                            "help": false,
                            "workbook": true
                    ...
                    children: [{
                        ...
                        problem: '\\grp'
                                    +'{\\mixed{\\str{$whole1}}{\\frac{\\str{$num1}}{\\str{$den1}}}}'
                                    +'{\\sign{&minus;}}{\\mixed{\\str{$whole2}}{\\frac{\\str{$num2}}{\\str{$den2}}}}',
                        answer: '\\css'
                                +'{\\rowgrp'
                                    +'{\\html{Determine the lowest common denominator (LCD) of the fractions:}}'
                                    +'{\\html{&nbsp;}}'
                        ...
                        problem: '\\grp'
                                    +'{\\mixed{\\str{$whole1}}{\\frac{\\str{$num1}}{\\str{$den1}}}}'
                                    +'{\\sign{&minus;}}'
                                    +'{\\mixed{\\str{$whole2}}{\\frac{\\str{$num2}}{\\str{$den2}}}}{border-bottom-with-padding}}',
                        answer: '\\css'
                                    +'{\\rowgrp'
                                        +'{\\html{Determine the lowest common denominator (LCD) of the fractions:}}'
                                        +'{\\html{&nbsp;}}'
