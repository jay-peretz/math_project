					...
					children: [{
						...
						answer: '\\css'
									+'{\\rowgrp'
										...
										+'{\\grp{\\sign{+}}{\\grp{\\mixed{\\str{$whole2}}{\\frac{\\str{$numnew2}}{\\str{$answerDen}}}}}}'
										+'{\\sign{=}}'
										+'{\\grp{\\mixed{\\input{$wholeanswer1}}{\\frac{\\input{$numanswer1}}{\\input{$answerDen}}}}}}'
										+'{\\html{&nbsp;}}'
									+'}{well}',
						controls: {
							"checkAnswer": true,
						...
						answer: '\\css'
									+'{\\rowgrp'
										...
										+'{\\grp{\\sign{+}}{\\grp{\\mixed{\\str{$whole2}}{\\frac{\\str{$numnew2}}{\\str{$answerDen}}}}}}'
										+'{\\sign{=}}'
										+'{\\grp{\\mixed{\\fracstr{$wholeanswer1}}{\\frac{\\fracstr{$numanswer1}}{\\fracstr{$answerDen}}}}}}'
										+'{\\html{&nbsp;}}'
										+'{\\ins{Rewrite the answer as a mixed number with a proper fraction:}}'
										+'{\\grp{\\mixed{\\str{$wholeanswer1}}{\\frac{\\str{$numanswer1}}{\\str{$answerDen}}}}{\\sign{ = }}{\\mixed{\\input{$wholeanswer2}}{\\frac{\\input{$numanswer2}}{\\input{$answerDen}}}}}'
									+'}{well}',
						controls: {
							"checkAnswer": true,
							"help": true
				...
				children: [{
					...
					children: [{
						...
						answer: '\\css{\\grp'
								...
								+'{\\sign{+}}{\\mixed{\\str{$whole2}}{\\frac{\\fracstr{$num2}}{\\fracstr{$den2}}}}'
								+'{\\sign{=}}'
								+'{\\mixed{\\input{$wholeanswer2}}{\\frac{\\input{$numanswer2}}{\\input{$answerDen2}}}}}',
								//+'{centerTableText3}',
						controls: {
							"checkAnswer": true,
							"help": false,
					...
					children: [{
						...
						answer: '\\css'
									+'{\\rowgrp'
										...
										+'{\\grp{\\mixed{\\str{$whole2}}{\\frac{\\fracstr{$num2}}{\\fracstr{$den2}}}}'
										+'{\\sign{=}}'
										+'{\\mixed{\\str{$whole2}}{\\frac{\\input{$numnew2}}{\\fracstr{$answerDen1}}}}}'
										+'{\\html{&nbsp;}}'
									+'}{well}',
						controls: {
							"checkAnswer": true,
						...
						answer: '\\css'
									...
									+'{\\html{&nbsp;}}'
									+'{\\ins{Add the fractions:}}'
									+'{\\grp{\\mixed{\\str{$whole1}}{\\frac{\\str{$numnew1}}{\\str{$answerDen1}}}}'
									+'{\\sign{+}}{\\grp{\\css{\\mixed{\\str{$whole2}}{\\frac{\\str{$numnew2}}{\\str{$answerDen1}}}}}}'
									+'{\\sign{=}}'
						...
						answer: '\\css'
									+'{\\rowgrp'
										...
										+'{\\html{&nbsp;}}'
										+'{\\grp{\\mixed{\\str{$whole1}}{\\frac{\\str{$numnew1}}{\\str{$answerDen1}}}}'
										+'{\\sign{+}}{\\mixed{\\str{$whole2}}{\\frac{\\str{$numnew2}}{\\str{$answerDen1}}}}'
										+'{\\sign{=}}'
