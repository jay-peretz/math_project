...
angular.module('mathSkills').service('data_g_3', ['dataUtils', function (dataUtils) {
    var desc = {
        ...
        data = [
			...
			// problem 7
			{ whole1: 3, num1: 2, den1: 3, whole2: 2, num2: '', den2: '', wholeanswer: 5, numanswer1: 17, numanswer2: 2, answerDen: 3, numnew1: 11, numnew2: 2, numlcd1: 11, numlcd2: 6, template: 'sixth' },
			// problem 8
