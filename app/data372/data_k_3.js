...
angular.module('mathSkills').service('data_k_3', ['dataUtils', function (dataUtils) {
    var desc = {
        ...
        data = [
			...
			template: 'rewriteDblNegSolve'},
			//problem 5
			{ problemStatement: 'Choose the correct math translation for the expression:<br><br>Subtract 6 from 8',
			...
			//problem 7
			{ problemStatement: 'Choose the correct math translation for the expression:<br><br>Find the sum of 6 and <span class=bigger>-</span>14',
			...
			template: 'rewriteSolve'},
			//problem 8
			{ problemStatement: 'Choose the correct math translation for the expression:<br><br>Find the difference of <span class=bigger>-</span>25 and 10',
			...
			template: 'rewriteSolve'},
			//problem 9
			{ problemStatement: 'Choose the correct math translation for the expression:<br><br>Find the difference of 4 and 9',
			...
			template: 'rewriteSolveDblNeg'},
			//problem 11
			{ problemStatement: 'Choose the correct math translation for the expression:<br><br>Find the sum of -0.5 and -3.8',
			...
			template: 'rewriteSolveDblNeg'},
			//problem 13
			{ problemStatement: 'Choose the correct math translation for the expression:<br><br>Subtract 22.4 from 17.3',
