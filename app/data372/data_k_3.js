    ...
    var desc = {
        ...
        data = [
			...
			{ problemStatement: 'Choose the expression that is rewritten correctly without any double negatives:<br><br><span class=bigger>-</span>( <span class=bigger>-</span>( <span class=bigger>-</span>5.2 ) ) <span class=bigger>-</span> ( <span class=bigger>-</span>3.1 ) <span class=bigger>+</span> ( <span class=bigger>-</span>4 )',
			  helpStatement: '<span class=bigger>-</span>( <span class=bigger>-</span>( <span class=bigger>-</span>5.2 ) ) <span class=bigger>-</span> ( <span class=bigger>-</span>3.1 ) <span class=bigger>+</span> ( <span class=bigger>-</span>4 )<br><br>The minus sign in front of a parenthesis means to take the opposite sign of the negative number inside the parenthesis, in this case the opposite sign of the negative number 5.2 and the opposite sign of the negative number 3.1.<br><br>Our expression becomes:<br><br><span class=bigger>-</span> 5.2 <span class=bigger>+</span> 3.1 <span class=bigger>-</span> 4',
