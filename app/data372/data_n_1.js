...
angular.module('mathSkills').service('data_n_1', ['dataUtils', function (dataUtils) {
    var desc = {
        ...
        data = [
			...
			template: 'first' },
			// problem 4
			{ problemStatement: '-11 - 18 / 6', ordopsStatement: '-11 - 18 / 6', answer: '4',
			wb: dataUtils.pre('\\ordopssimple{' +
			...
			template: 'first' },
			// problem 6
			{ problemStatement: '-6 \xA0*\xA0 7 + 14 / -2', ordopsStatement: '-6  *  7 + 14 / -2', answer: '-49',
			wb: dataUtils.pre('\\ordopssimple{' +
			...
			wb: dataUtils.pre('\\ordopssimple{' +
                        ...
                        '\\input{-4},' +
                       '\\grp{\\str{-6}}{\\btn{-}{F}{bigger}}{\\str{2}}{\\btn{&bull;}{T}{bigger}}{\\str{-4}},' +
                        '\\input{-8},' +
			...
			wb: dataUtils.pre('\\ordopssimple{' +
                        ...
                        '\\input{-5},' +
                       '\\grp{\\str{7}}{\\btn{-}{F}{bigger}}{\\str{5}}{\\btn{&bull;}{T}{bigger}}{\\str{-5}},' +
                        '\\input{-25},' +
			...
			wb: dataUtils.pre('\\ordopssimple{' +
                       ...
                       '\\grp{\\str{-4}}{\\str{(}}{\\str{-10}}{\\btn{-}{T}{bigger}}{\\str{8}}{\\str{)}},' +
                        '\\input{-18},' +
						'\\grp{\\str{-4}}{\\btn{&bull;}{T}{bigger}}{\\str{-18}},' +
                        '\\input{72},' +
						'\\grp{\\str{72}},' +
			...
			{ problemStatement: '-3 (-3 / -3 - 1)', ordopsStatement: '-3 (-3 / -3 - 1)', answer: '0', 
			  wb: dataUtils.pre('\\ordopssimple{' +
                       ...
                       '\\grp{\\str{-3}}{\\str{(}}{\\str{1}}{\\btn{-}{T}{bigger}}{\\str{1}}{\\str{)}},' +
                        '\\input{0},' +
						'\\grp{\\str{-3}}{\\btn{&bull;}{T}{bigger}}{\\str{0}},' +
                        '\\input{0},' +
						'\\grp{\\str{0}},' +
