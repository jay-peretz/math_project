	...
	children: [
		...
		},
		{
			...
			children: [{
				...
				children: [{
					...
					answer: '\\css{\\butgrp{\\rowgrp{\\row{\\str{\xA0}}}{\\row{\\but{A}{F}}{\\css{\\str{$20.00 more}}{button-label-margin}}}{\\row{\\but{B}{T}}{\\css{\\str{$16.00 more}}{button-label-margin}}}{\\row{\\but{C}{F}}{\\css{\\str{$10.00 more}}{button-label-margin}}}{\\row{\\but{D}{F}}{\\css{\\str{$5.00 more}}{button-label-margin}}}}}{buttonsright}',
					controls: {
						"checkAnswer": true,
		...
		},
		{
			...
			children: [{
				...
				children: [{
					...
					answer: '\\css{\\butgrp{\\rowgrp{\\row{\\str{\xA0}}}{\\row{\\but{A}{F}}{\\css{\\str{7 employees}}{button-label-margin}}}{\\row{\\but{B}{F}}{\\css{\\str{15 employees}}{button-label-margin}}}{\\row{\\but{C}{T}}{\\css{\\str{17 employees}}{button-label-margin}}}{\\row{\\but{D}{F}}{\\css{\\str{180 employees}}{button-label-margin}}}}}{buttonsright}',
					controls: {
						"checkAnswer": true,
		...
		},
		{
			...
			children: [{
				...
				children: [{
					...
					answer: '\\css{\\butgrp{\\rowgrp{\\row{\\str{\xA0}}}{\\row{\\but{A}{F}}{\\css{\\str{Months}}{button-label-margin}}}{\\row{\\but{B}{F}}{\\css{\\str{Deer Survey in Sonoma County}}{button-label-margin}}}{\\row{\\but{C}{F}}{\\css{\\str{Deer Population}}{button-label-margin}}}{\\row{\\but{D}{T}}{\\css{\\str{Number of Deer Counted}}{button-label-margin}}}}}{buttonsright}',
					controls: {
						"checkAnswer": true,
		...
		},
		{
			...
			children: [{
				...
				children: [{
					...
					answer: '\\css{\\butgrp{\\rowgrp{\\row{\\but{A}{T}}{\\css{\\str{445 Deer}}{button-label-margin}}}{\\row{\\but{B}{F}}{\\css{\\str{380 Deer}}{button-label-margin}}}{\\row{\\but{C}{F}}{\\css{\\str{410 Deer}}{button-label-margin}}}{\\row{\\but{D}{F}}{\\css{\\str{300 Deer}}{button-label-margin}}}}}{buttonsright}',
					controls: {
						"checkAnswer": true,
		...
		},
		{
			...
			children: [{
				title: 'Main Answer',
				children: [{
					problem: '\\rowgrp{\\row{\\str{Approximately how many deer were counted in the first two periods of the survey (January and April)?}}}{\\row{\\str{\xA0}}}{\\row{\\graph{Deer Survey in Sonoma County}{[ ["January", 220], ["April", 370], ["July", 445], ["October", 300]]}{500}{Number of Deer Counted}}}',
					answer: '\\css{\\butgrp{\\rowgrp{\\row{\\str{\xA0}}}{\\row{\\but{A}{F}}{\\css{\\str{450 Deer}}{button-label-margin}}}{\\row{\\but{B}{F}}{\\css{\\str{680 Deer}}{button-label-margin}}}{\\row{\\but{C}{T}}{\\css{\\str{590 Deer}}{button-label-margin}}}{\\row{\\but{D}{F}}{\\css{\\str{500 Deer}}{button-label-margin}}}}}{buttonsright}',
					controls: {
						"checkAnswer": true,
		...
		},
		{
			...
			children: [{
				...
				children: [{
					...
					answer: '\\css{\\butgrp{\\rowgrp{\\row{\\but{A}{F}}{\\css{\\str{20 years}}{button-label-margin}}}{\\row{\\but{B}{F}}{\\css{\\str{10 years}}{button-label-margin}}}{\\row{\\but{C}{F}}{\\css{\\str{10 million}}{button-label-margin}}}{\\row{\\but{D}{T}}{\\css{\\str{5 million}}{button-label-margin}}}}}{buttonsright}',
					controls: {
						"checkAnswer": true,
		...
		},
		{
			...
			children: [{
				...
				children: [{
					...
					answer: '\\css{\\butgrp{\\rowgrp{\\row{\\but{A}{F}}{\\css{\\str{22 million}}{button-label-margin}}}{\\row{\\but{B}{F}}{\\css{\\str{18 million}}{button-label-margin}}}{\\row{\\but{C}{T}}{\\css{\\str{11 million}}{button-label-margin}}}{\\row{\\but{D}{F}}{\\css{\\str{9 million}}{button-label-margin}}}}}{buttonsright}',
					controls: {
						"checkAnswer": true,
		...
		},
		{
			...
			children: [{
				...
				children: [{
					...
					answer: '\\css{\\butgrp{\\rowgrp{\\row{\\but{A}{F}}{\\css{\\str{2 million}}{button-label-margin}}}{\\row{\\but{B}{F}}{\\css{\\str{3 million}}{button-label-margin}}}{\\row{\\but{C}{F}}{\\css{\\str{4 million}}{button-label-margin}}}{\\row{\\but{D}{T}}{\\css{\\str{1 million}}{button-label-margin}}}}}{buttonsright}',
					controls: {
						"checkAnswer": true,
