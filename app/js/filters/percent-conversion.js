    ...
    .filter('percent-conversion', [
        function () {
            return function (parametersArray) {
					...
					var decimalDigits = function (num) {
						...
						var decimalNotPercentFunc = function(parametersArray) {
							...
							console.log (" in decimalNotPercentFunc, parametersArray[2] is: "+parametersArray[2]);
							switch (true) {
						...
						var decimalAsPercentFunc = function(decimalNumber) {
							...
							if (displayConsoleLogPercentObjects) {				
								console.log (
									 "in setDecimalAsPercent decimalNotPercent is: "+decimalNotPercent+
									 " decimalAsPercent is: "+decimalAsPercent+
									 " percentAsFraction is: "+percentAsFraction+
									 " fractionPercentAsFraction is: "+fractionPercentAsFraction+
									 " decimalAsFractionPercent is: "+decimalAsFractionPercent+
									 " fractionPercentAsDecimal is: "+fractionPercentAsDecimal
								);
							}
						}
						...
						var percentAsFractionFunc = function(fraction) {
							...
							if (displayConsoleLogPercentObjects) {				
								console.log (
									 "in setPercentAsFraction decimalNotPercent is: "+decimalNotPercent+
									 " decimalAsPercent is: "+decimalAsPercent+
									 " percentAsFraction is: "+percentAsFraction+
									 " fractionPercentAsFraction is: "+fractionPercentAsFraction+
									 " decimalAsFractionPercent is: "+decimalAsFractionPercent+
						...
						var fractionPercentAsFractionFunc = function(fraction) {
							...
							if (displayConsoleLogPercentObjects) {				
								console.log (
									 "in setFractionPercentAsFraction decimalNotPercent is: "+decimalNotPercent+
									 " decimalAsPercent is: "+decimalAsPercent+
									 " percentAsFraction is: "+percentAsFraction+
									 " fractionPercentAsFraction is: "+fractionPercentAsFraction+
									 " decimalAsFractionPercent is: "+decimalAsFractionPercent+
			...
			fractionPercentAsFraction = fractionMultiply([percentAsFraction, ({numerator: 1, denominator: 100})]);
							...
							if (displayConsoleLogPercentObjects) {				
								console.log (
									 "in setDecimalAsFractionPercent decimalNotPercent is: "+decimalNotPercent+
									 " decimalAsPercent is: "+decimalAsPercent+
									 " percentAsFraction is: "+percentAsFraction+
									 " fractionPercentAsFraction is: "+fractionPercentAsFraction+
									 " decimalAsFractionPercent is: "+decimalAsFractionPercent+
						...
						switch (true) {
							case (parametersArray[1] === "decimalNotPercent"):
								console.log("decimalNotPercentFunc(parametersArray) is: "+decimalNotPercentFunc(parametersArray))
