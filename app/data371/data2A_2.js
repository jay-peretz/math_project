        ...
        template = {
			...
			tenth: {
					...
					children: [{
						title: 'Main Answer',
						children: [{
							problem: '\\pan{6}{6}{\\col{\\row{\\str{What is the label for the vertical axis?}}}{\\html{&nbsp;}}{\\row{\\graph{Hourly Wages at Budget Warehouse}{[ ["A", 6], ["B", 7], ["C", 12], ["D", 15], ["E", 22], ["Manager", 27] ]}{30}{Hourly Wage}}}',
			...
			eleventh: {
					...
					children: [{
						title: 'Main Answer',
						children: [{
							problem: '\\pan{6}{6}{\\col{\\row{\\str{Approximately how much more money per hour does a Class E worker make than Class A worker?}}}{\\row{\\str{\xA0}}}{\\row{\\graph{Hourly Wages at Budget Warehouse}{[ ["A", 6], ["B", 7], ["C", 12], ["D", 15], ["E", 22], ["Manager", 27] ]}{30}{Hourly Wage}}}}}',
			...
			twelveth: {
					...
					children: [{
						title: 'Main Answer',
						children: [{
							problem: '\\pan{6}{6}{\\col{\\row{\\str{If there are 100 Class A workers, 50 class B workers, 30 class C workers, 10 class D workers, 5 class E workers, and 2 managers, how many employees earn $15 an hour or more?}}}{\\row{\\str{\xA0}}}{\\row{\\graph{Hourly Wages at Budget Warehouse}{[ ["A", 6], ["B", 7], ["C", 12], ["D", 15], ["E", 22], ["Manager", 27] ]}{30}{Hourly Wage}}}}',
			...
			thirteenth: {
					...
					children: [{
						title: 'Main Answer',
						children: [{
							problem: '\\pan{6}{6}{\\col{\\row{\\str{What is the label for the vertical axis?}}}{\\row{\\str{\xA0}}}{\\row{\\graph{Deer Survey in Sonoma County}{[ ["January", 220], ["April", 370], ["July", 445], ["October", 300]]}{500}{Number of Deer Counted}}}}',
			...
			fourteenth: {
					...
					children: [{
						title: 'Main Answer',
						children: [{
							problem: '\\pan{6}{6}{\\col{\\row{\\str{Approximately how many deer were counted in July?}}}{\\row{\\str{\xA0}}}{\\row{\\graph{Deer Survey in Sonoma County}{[ ["January", 220], ["April", 370], ["July", 445], ["October", 300]]}{500}{Number of Deer Counted}}}}',
			...
			fifteenth: {
					...
					children: [{
						title: 'Main Answer',
						children: [{
							problem: '\\pan{6}{6}{\\col{\\row{\\str{Approximately how many deer were counted in the first two periods of the survey (January and April)?}}}{\\row{\\str{\xA0}}}{\\row{\\graph{Deer Survey in Sonoma County}{[ ["January", 220], ["April", 370], ["July", 445], ["October", 300]]}{500}{Number of Deer Counted}}}}',
			...
			sixteenth: {
					...
					children: [{
						title: 'Main Answer',
						children: [{
							problem: '\\pan{6}{6}{\\col{\\row{\\str{Question 1: What is the increment for the horizontal axis?}}}{\\row{\\str{\xA0}}}{\\row{\\horgraph{Country A:  Food Production and Population}{[[0, "1965"], [2, "1965"], null, [0, "1985"], [3, "1985"], null, [0, "2005"], [11, "2005"], null, [0, "2025"],[22, "2025"]]}{Population of Country A}{[[0, "1962"], [3, "1962"], null, [0, "1982"], [5, "1982"], null, [0, "2002"], [9, "2002"], null, [0, "2022"],[18, "2022"]]}{Population Country A can Feed}{Years}{Number (in millions)}}}{\\row{\\str{\xA0}}}}',
