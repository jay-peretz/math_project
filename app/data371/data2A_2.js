...
angular.module('mathSkills').service('data2A_2', ['dataUtils', function (dataUtils) {
    var desc = {
        ...
        data = [
            ...
            {  //2
                chart: dataUtils.pre('\\chart{Time (in seconds) to Run 220 Meters}{6}{5}{["Athlete","Race #1","Race #2","Race #3","Race #4","Runner A","27","29","29","29","Runner B","30","28","28","26","Runner C","26","30","27","24","Runner D","24","28","30","28","Runner E","27","24","28","24"]}'), 
                question: 'Question 2:<br><br>Which athlete took the least amount of time to finish Race #2?', template: 'main',
            ...
            {  //3
                chart: dataUtils.pre('\\chart{Time (in seconds) to Run 220 Meters}{6}{5}{["Athlete","Race #1","Race #2","Race #3","Race #4","Runner A","27","29","29","29","Runner B","30","28","28","26","Runner C","26","30","27","24","Runner D","24","28","30","28","Runner E","27","24","28","24"]}'), 
                question: 'Question 3:<br><br>How many of the runners had a time of 25 seconds or better in at least one race?', template: 'main',
            ...
            {  //7
                ...
                question: 'Question 1:<br><br>For the four students, which student spent the most for Phone and Gas?', template: 'main',
            ...
            {  //8
                chart: dataUtils.pre('\\chart{}{5}{5}{["Student","Phone","Internet","Cable TV","Gas","Sam","41","16","40","69","Jerry","64","60","59","65","Maribel","94","67","67","99","Yvonne","41","69","34","113"]}'), 
                question: 'Question 2:<br><br>Which service given in these four choices is the most expensive for the four students all together?', template: 'main',
            ...
            {  //9
                chart: dataUtils.pre('\\chart{}{5}{5}{["Student","Phone","Internet","Cable TV","Gas","Sam","41","16","40","69","Jerry","64","60","59","65","Maribel","94","67","67","99","Yvonne","41","69","34","113"]}'), 
                question: 'Question 3:<br><br>Which service given in these four choices is the least expensive for the four students all together?', template: 'main',
            ...
            {  //10
                ...
                question: 'Question 1:<br><br>What is the label for the vertical axis?', template: 'main',
            ...
            {  //11
                chart: dataUtils.pre('\\graph{Hourly Wages at Budget Warehouse}{[ ["A", 6], ["B", 7], ["C", 12], ["D", 15], ["E", 22], ["Manager", 27] ]}{30}{Hourly Wage}'), 
                question: 'Question 2:<br><br>Approximately how much more money per hour does a Class E worker make than Class A worker?', template: 'main',
            ...
            {  //12
                chart: dataUtils.pre('\\graph{Hourly Wages at Budget Warehouse}{[ ["A", 6], ["B", 7], ["C", 12], ["D", 15], ["E", 22], ["Manager", 27] ]}{30}{Hourly Wage}'), 
                question: 'Question 3:<br><br>If there are 100 Class A workers, 50 class B workers, 30 class C workers, 10 class D workers, 5 class E workers, and 2 managers, how many employees earn $15 an hour or more?', template: 'main',
            ...
            {  //14
                chart: dataUtils.pre('\\graph{Deer Survey in Sonoma County}{[ ["January", 220], ["April", 370], ["July", 445], ["October", 300]]}{500}{Number of Deer Counted}'), 
                question: 'Question 2:<br><br>Approximately how many deer were counted in July?', template: 'main',
            ...
            {  //15
                chart: dataUtils.pre('\\graph{Deer Survey in Sonoma County}{[ ["January", 220], ["April", 370], ["July", 445], ["October", 300]]}{500}{Number of Deer Counted}'), 
                question: 'Question 3:<br><br>Approximately how many deer were counted in the first two periods of the survey (January and April)?', template: 'main',
            ...
            {  //16
                ...
                question: 'Question 1:<br><br>What is the increment for the horizontal axis?', template: 'main',
            ...
            {  //17
                chart: dataUtils.pre('\\horgraph{Country A:  Food Production and Population}{[[0, "1965"], [2, "1965"], null, [0, "1985"], [3, "1985"], null, [0, "2005"], [11, "2005"], null, [0, "2025"],[22, "2025"]]}{Population of Country A}{[[0, "1962"], [3, "1962"], null, [0, "1982"], [5, "1982"], null, [0, "2002"], [9, "2002"], null, [0, "2022"],[18, "2022"]]}{Population Country A can Feed}{Years}{Number (in millions)}'), 
                question: 'Question 2:<br><br>Approximately what number represents the population of Country A in 2005?', template: 'main',
            ...
            {  //18
                chart: dataUtils.pre('\\horgraph{Country A:  Food Production and Population}{[[0, "1965"], [2, "1965"], null, [0, "1985"], [3, "1985"], null, [0, "2005"], [11, "2005"], null, [0, "2025"],[22, "2025"]]}{Population of Country A}{[[0, "1962"], [3, "1962"], null, [0, "1982"], [5, "1982"], null, [0, "2002"], [9, "2002"], null, [0, "2022"],[18, "2022"]]}{Population Country A can Feed}{Years}{Number (in millions)}'), 
                question: 'Question 3:<br><br>Approximately what number represents the increase in population from 1965 to 1985?', template: 'main',
