                            ...
                            '\\wb{' +
                                '\\rowgrp' +
                                    '{\\choose{[' +
                                        ...
                                        '\\ins{We must divide to solve this problem.  The <u>given total value of the subdivision</u> is being divided up into $number identically-priced houses.  Write a set up that will solve for the value of each house.}' +    
                                    ']}{$$previousCorrect}}' +                                    
									'{\\grp{\\select{$firstunitwhole $firstunitn/$firstunitd million dollars}{["$firstunitwhole $firstunitn/$firstunitd million dollars", "$number"]}}{\\sign{&div;}}{\\select{$number}{["$firstunitwhole $firstunitn/$firstunitd million dollars", "$number"]}}}' +
                            	'}',
                        controls: {
                            "checkAnswer": true,
                            "help": true
                            ...
                            '\\wb{' +
                                '\\rowgrp' +
                                    '{\\choose{[' +
                                        ...
                                        '\\ins{This is a division problem.  When we set up a division problem, the <u>first number must be the total</u> that is being divided up.  In this case the $total is the total value of the subdivision (&#36;$firstunitwhole <sup>$firstunitn</sup>&#8260;<sub>$firstunitd</sub> million dollars) and is placed first in the division set up.  The correct setup is shown below.<br><br>Now solve the problem.}' +
                                    ']}{$$previousCorrect}}' +
                                    '{\\grp{\\frac{\\str{$total}}{\\str{1}}}{\\sign{&div;}}{\\frac{\\str{$number}}{\\str{1}}}{\\sign{=}}{\\frac{\\input{$firstunitn}}{\\input{$firstunitd}}}{\\html{million dollars}}}' +
                            '}',
                        controls: {
                            "checkAnswer": true,
                            "help": true
