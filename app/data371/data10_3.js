...
angular.module('mathSkills').service('data10_3', ['dataUtils', function (dataUtils) {
    var desc = {
					...
					children: [{
						...
						answer: '\\css'
									+'{\\rowgrp'
										...
										+'{\\grp{\\sign{+}}{\\grp{\\css{\\mixed{\\str{$whole2}}{\\frac{\\str{$numnew2}}{\\str{$answerDen}}}}{border-bottom-with-padding}}}}'
										+'{\\html{&nbsp;}}'
										+'{\\grp{\\html{<span style="font-size:300%;">&nbsp;</span>}}{\\mixed{\\fracstr{$wholeanswer1}}{\\frac{\\fracstr{$numanswer1}}{\\fracstr{$answerDen}}}}}'
										+'{\\html{&nbsp;}}'
			...
			third: {
				...
				children: [{
					...
					children: [{
						...
						+'{\\css{\\grp{\\sign{+}}{\\mixed{\\str{$whole2}}{\\frac{\\fracstr{$num2}}{\\fracstr{$den2}}}}}{border-bottom-with-padding}}'
						+'{\\html{&nbsp;}}'
						+'{\\grp{\\sign{\xA0 \xA0}}{\\mixed{\\input{$wholeanswer2}}{\\frac{\\input{$numanswer2}}{\\input{$answerDen1}}}}}}'
						+'{centerTableText3}',
						controls: {
							"checkAnswer": true,
							"help": false,
			...
			seventh: {
				...
				children: [{
					...
					children: [{
						...
						+'{\\html{&nbsp;}}'
						+'{\\grp{\\sign{+}}{\\css{\\mixed{\\str{$whole3}}{\\frac{\\fracstr{$num3}}{\\fracstr{$den3}}}}{border-bottom-with-padding}}}',
						answer: '\\input{$answerDen1}',
						controls: {
							"checkAnswer": true,
							"help": '\\rowgrp'
							+'{\\str{The LCD of $den1, $den2 and $den3 is $answerDen1.}}'
							+'{\\html{&nbsp;}}'
							+'{\\css{\\str{\xA0 Answer: \xA0 $answerDen1}}{help-answer-text}}'
						},
					}, {
						problem: '\\str{Use the LCD to convert the fractions: }',
						answer: '\\rowgrp{\\grp{\\mixed{\\str{$whole1}}{\\frac{\\str{$num1}}{\\str{$den1}}}}{\\sign{\xA0 \xA0 = \xA0 \xA0}}{\\mixed{\\str{$whole1}}{\\frac{\\input{$numnew1}}{\\str{$answerDen1}}}}}{\\grp{\\str{\xA0}}}{\\grp{\\mixed{\\str{$whole2}}{\\frac{\\str{$num2}}{\\str{$den2}}}}{\\sign{\xA0 \xA0 = \xA0 \xA0}}{\\mixed{\\str{$whole2}}{\\frac{\\input{$numnew2}}{\\str{$answerDen1}}}}}{\\grp{\\str{\xA0}}}{\\grp{\\mixed{\\str{$whole3}}{\\frac{\\str{$num3}}{\\str{$den3}}}}{\\sign{\xA0 \xA0 = \xA0 \xA0}}{\\mixed{\\str{$whole3}}{\\frac{\\input{$numnew3}}{\\str{$answerDen1}}}}}',
						controls: {
							"checkAnswer": true,
							"help": true
						}
						...
						answer: '\\css{\\rowgrp'
						+'{\\grp{\\sign{\xA0 \xA0 \xA0 \xA0}}{\\mixed{\\str{$whole1}}{\\frac{\\str{$numnew1}}{\\str{$answerDen1}}}}}'
						+'{\\html{&nbsp;}}'
						+'{\\grp{\\sign{\xA0 \xA0 \xA0 \xA0}}{\\mixed{\\str{$whole2}}{\\frac{\\str{$numnew2}}{\\str{$answerDen1}}}}}'
						+'{\\html{&nbsp;}}'
						+'{\\css{\\grp{\\sign{\xA0 \xA0 + }}{\\mixed{\\str{$whole3}}{\\frac{\\str{$numnew3}}{\\str{$answerDen1}}}}}{border-bottom-with-padding}}'
						+'{\\html{&nbsp;}}'
						+'{\\grp{\\sign{\xA0 \xA0 \xA0}}{\\mixed{\\input{$wholeanswer1}}{\\frac{\\input{$numanswer1}}{\\input{$answerDen1}}}}}}{centerTableText3}',
						controls: {
							"checkAnswer": true,
							"help": true
						}
					}, {
						problem: '\\row{\\str{Reduce \xA0}}{\\mixed{\\str{$wholeanswer1}}{\\frac{\\fracstr{$numanswer1}}{\\fracstr{$answerDen1}}}}{\\str{\xA0 to its lowest terms }}',
						answer: '\\reducefrac{\\mixed{\\str{$wholeanswer1}}{\\frac{\\fracstr{$numanswer1}}{\\fracstr{$answerDen1}}}}',
						controls: {
							"checkAnswer": true,
							"help": false
						}
						...
						answer: '\\rowgrp{\\grp{\\mixed{\\str{$wholeanswer1}}{\\frac{\\str{$numanswer2}}{\\str{$answerDen2}}}}{\\sign{\xA0 \xA0 = \xA0 \xA0}}{\\mixed{\\input{$wholeanswer2}}{\\frac{\\input{$numanswer3}}{\\input{$answerDen2}}}}}',
						controls: {
							"checkAnswer": true,
							"help": true
						}
        ...
        data = [
			...
			/*{ whole1: 1, num1: 1, den1: 12, whole2: 2, num2: 3, den2: '\xA04\xA0', whole3: 3,  num3: 5, den3: '\xA06\xA0', wholeanswer1: 6, numanswer1: 20, answerDen1: 12, numnew1: '\xA01', numnew2: '\xA09', numnew3: 10, wholeanswer2: 7, numanswer2: 5, answerDen2: 3, numanswer3: 2, template: 'seventh' }*/
        ];
