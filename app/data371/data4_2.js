...
angular.module('mathSkills').service('data4_2', ['dataUtils', function (dataUtils) {
    var desc = {
        ...
        data = [
			...
			{ problemStatement: '27 <span class=bigger>&divide;</span> 9 <span class=bigger>+</span> 6 <span class=margin-not-bigger>&bull;</span> 8 <span class=bigger>&minus;</span> 35', ordopsStatement: '27 / 9 + 6 * 8 - 35)', answer: '16', template: 'first' },
        ];
