                ...
                children: [{
                    ...
                    children: [{
						problem: '\\rowgrp'
									...
									+'{\\grp'
										+'{\\html{$initialAmount}}'
										+'{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$firstImage>}}'
										+'{\\sign{&equals;}}'
										+'{\\html{?}}'
										+'{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$fourthImage>}}'
									+'}',
                        answer: '\\grp'
									+'{\\input{$fourthAnswer}}'
									+'{\\html{c}}'
                    ...
                    children: [{
                        problem: '\\rowgrp'
									...
									+'{\\html{&nbsp;}}'
									+'{\\grp'
										+'{\\html{$initialAmount}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$firstImage>}}'
										+'{\\sign{&equals;}}'
										+'{\\html{?}}'
										+'{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$fourthImage>}}'
									+'}',
                        ...
                        problem: '\\rowgrp'
									...
									+'{\\html{&nbsp;}}'
									+'{\\grp'
										+'{\\frac{\\grp{\\html{$numeratorStart}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$firstImage>}}}{\\grp{\\css{\\html{&nbsp;}}{image-height}}{\\html{$denominatorStart}}}}'
										+'{\\sign{&times;}}'
										+'{\\frac{\\grp{\\html{4}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$secondImage>}}}{\\grp{\\html{1}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$firstImage>}}}}'
										+'{\\sign{&equals;}}{\\html{?}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$fourthImage>}}}',
                        answer: '\\pan{12}{11}'
									+'{\\rowgrp'
                        ...
                        problem: '\\rowgrp'
									...
									+'{\\grp'
										...
										+'{\\frac{\\grp{\\html{4}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$secondImage>}}}{\\grp{\\html{1}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$firstImage>}}}}'
										+'{\\sign{&times;}}'
										+'{\\frac{\\grp{\\html{2}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$thirdImage>}}}{\\grp{\\html{1}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$secondImage>}}}}'
										+'{\\sign{&equals;}}'
										+'{\\html{?}}'
										+'{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$fourthImage>}}}',
                        answer: '\\pan{12}{11}'
                        ...
                        problem: '\\rowgrp'
									...
									+'{\\grp'
										...
										+'{\\frac{\\grp{\\html{2}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$thirdImage>}}}{\\grp{\\html{1}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$secondImage>}}}}'
										+'{\\sign{&times;}}'
										+'{\\frac{\\grp{\\html{2}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$fourthImage>}}}{\\grp{\\html{1}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$thirdImage>}}}}'
										+'{\\sign{&equals;}}{\\html{?}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$fourthImage>}}'
									+'}',
                        answer: '\\pan{12}{11}'
									+'{\\rowgrp'
                ...
                children: [{
                    ...
                    children: [{
						problem: '\\rowgrp'
									...
									+'{\\html{&nbsp;}}'
									+'{\\grp'
										+'{\\html{$initialAmount}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$secondImage>}}'
										+'{\\sign{&equals;}}'
										+'{\\html{?}}'
										+'{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$fourthImage>}}'
									+'}',
                    ...
                    children: [{
                        ...
                        problem: '\\rowgrp'
									...
									+'{\\html{&nbsp;}}'
									+'{\\grp'
										+'{\\frac{\\grp{\\html{$numeratorStart}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$secondImage>}}}{\\grp{\\css{\\html{&nbsp;}}{image-height}}{\\html{$denominatorStart}}}}'
										+'{\\sign{&times;}}'
										+'{\\frac{\\grp{\\html{2}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$thirdImage>}}}{\\grp{\\html{1}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$secondImage>}}}}'
										+'{\\sign{&equals;}}{\\html{?}}{\\html{<img src=img/math_project_images/23.1-Volume-Weight-Measure/$fourthImage>}}}',
                        answer: '\\pan{12}{11}'
