                    ...
                    children: [{
						...
						controls: {
							...
							"help": '\\rowgrp'
										...
										+'}'
										+'{html{&nbsp;}}'
										+'{html{To compare fractions, we must remake the fractions with a common denominator (&nbsp;<sup>$firstNum</sup>/<sub>$firstDen</sub>&nbsp; becomes &nbsp;<sup>$firstLCDNum</sup>/<sub>$lcdDen</sub>&nbsp; and &nbsp;<sup>$secondNum</sup>/<sub>$secondDen</sub>&nbsp; becomes &nbsp;<sup>$secondLCDNum</sup>/<sub>$lcdDen</sub>&nbsp;):}}'
										+'{html{&nbsp;}}'
										+'{\\grp'
