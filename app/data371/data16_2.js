...
angular.module('mathSkills').service('data16_2', ['dataUtils', function (dataUtils) {
    var desc = {
        ...
        data = [
			...
			{ problemNum1: '37.6', problemDen1: '42.3', problemNum2: '33.3', problemDen2: '36.6', label1: 'ounces', label2: 'tons', label3: 'ounces', label4: 'tons', buttonTrueValue: 'F', buttonFalseValue: 'T', helpNum1: '37.6', helpDen1: '42.3', helpNum2: '33.3', helpDen2: '36.6', productLeft: '1376.16', equalOrNot: '\u2260',  productRight: '1408.59', answerFirst: 'False', template: 'second' },
