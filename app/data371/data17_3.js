...
angular.module('mathSkills').service('data17_3', ['dataUtils', function (dataUtils) {
    var desc = {
        ...
        data = [
			...
			{ instructions: 'Detemine the unit price for the following ratio:',  quantityLabel1: '42', label1: '&cent;', quantityLabel2: '6', label2: 'feet', label3: '&cent;',  label4: 'foot', buttonValueA: 'F', buttonLabelA: '6', buttonValueB: 'F', buttonLabelB: '7', buttonValueC: 'F', buttonLabelC: '8', buttonValueD: 'T', buttonLabelD: '9', buttonLetter: 'C', answer: '8', rounded: '', template: 'main' },
