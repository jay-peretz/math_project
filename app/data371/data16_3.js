...
angular.module('mathSkills').service('data16_3',['dataUtils', function (dataUtils) {
    var ret = {
			...
			xUpperLeftFractionFraction: {
                ...
                children: [{
                    ...
                    children: [{
						...
						answer: '\\css{\\frac{\\input{$answerNum}}{\\input{$answerDen}}}{margin-left-small}',
						controls: {
							"checkAnswer": true,
							"help": '\\rowgrp'
							+'{\\row{\\str{\xA0}}}'
        ...
        data = [
			...
			{ problemNum1: '1', problemDen1: '', problemNum2: '2', problemDen2: '3', problemNum3: '5', problemDen3: '12', problemNum4: '5', problemDen4: '9', label1: 'apple', label2: 'orange',  label3: 'apple', label4: 'orange', productNumLeft: '', productDenLeft: '', productNumRight: '10', productDenRight: '36', answerWhole: '\xA0', answerNum: '1', answerDen: '2', template: 'xUpperLeftFractionFraction' },
        ];
