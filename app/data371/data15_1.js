...
angular.module('mathSkills').service('data15_1', ['dataUtils', function (dataUtils) {
	...
	data = [
		...
		// note that digitsRightInExponential is the total number of digits in the answer less 1
		// problem 4
		{ firstQuestion: 'Find the quotient of 7.5 and 40', roundStatement: '', dividend: '7.5', divisor: '40', extendedDividend: '7.5000', decimalMovedDivisor: '40',decimalMovedDividend: '7.5', digitsRightInExponential: "3", quotient: '0.1875', answer: '0.1875', buttonString: '\\grp{\\btn{7}{F}}{\\html{.}}{\\btn{5}{T}}', template: 'noDecimalShiftDivision' },
		// note that digitsRightInExponential is the total number of digits in the answer less 1
		// problem 5
		{ firstQuestion: '456.52 <span class=bigger>&divide;</span> 0.8 <span class=bigger>&equals;</span>', roundStatement: '', dividend: '456.52', divisor: '0.8', extendedDividend: '456.520', decimalMovedDivisor: '8', decimalMovedDividend: '4565.2', digitsRightInExponential: "4", quotient: '570.65', answer: '570.65', buttonString: '\\grp{\\btn{4}{F}}{\\btn{5}{T}}{\\btn{6}{F}}{\\btn{5}{F}}{\\html{.}}{\\btn{2}{F}}', template: 'division' },
		// note that digitsRightInExponential is the total number of digits in the answer less 1
		// problem 6
		{ firstQuestion: '0.125 <span class=bigger>&divide;</span> 5 <span class=bigger>&equals;</span>', roundStatement: '', dividend: '0.125', divisor: '5', extendedDividend: '0.125', decimalMovedDivisor: '5', decimalMovedDividend: '0.125', digitsRightInExponential: "2", quotient: '0.025', answer: '0.025', buttonString: '\\grp{\\btn{0}{F}}{\\html{.}}{\\btn{1}{F}}{\\btn{2}{T}}{\\btn{5}{F}}', template: 'noDecimalShiftDivision' },
		// note that digitsRightInExponential is the total number of digits in the answer less 1
		// problem 7
