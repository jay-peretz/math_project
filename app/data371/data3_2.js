...
angular.module('mathSkills').service('data3_2', ['dataUtils', function (dataUtils) {
    var desc = {
        ...
        data = [
			...
			{ problemStatement: 'How many times does 3 go into 3239?', instructions: 'Set up the division problem by placing the dividend and the divisor in the proper places.', divisor: '3', dividend: '3239', template: 'setupDivision' },
			{ problemStatement: 'Solve: x / y.', instructions: 'Set up the division problem by placing the dividend and the divisor in the proper places.', divisor: 'x', dividend: 'y', template: 'setupDivision' },
			{ problemStatement: 'How many times does 5 go into 7916?', instructions: 'Set up the division problem by placing the dividend and the divisor in the proper places.', divisor: '5', dividend: '7916', template: 'setupDivision' },
			{ problemStatement: 'How many times does 6 go into 2855?', instructions: 'Set up the division problem by placing the dividend and the divisor in the proper places.', divisor: '6', dividend: '2855', template: 'setupDivision' },
			...
			{ problemStatement: 'Solve: 5406 <span class=bigger>&divide;</span> 6.', instructions: 'Solve the problem.', divisor: '6', dividend: '5406', quotient: '901', remainder: '0', firstDigit: '5', secondDigit: '4', thirdDigit: '0', fourthDigit: '6', firstButton: 'F', secondButton: 'T', thirdButton: 'F', fourthButton: 'F', template: 'divisionFour' },
			{ problemStatement: 'Solve: 3027 <span class=bigger>&divide;</span> 3.', instructions: 'Solve the problem.', divisor: '3', dividend: '3027', quotient: '1009', remainder: '0', firstDigit: '3', secondDigit: '0', thirdDigit: '2', fourthDigit: '7', firstButton: 'T', secondButton: 'F', thirdButton: 'F', fourthButton: 'F', template: 'divisionFour' },
			...
			{ problemStatement: 'How many times does 3 go into 9381?', instructions: 'Solve the problem.', divisor: '3', dividend: '9381', quotient: '3127', remainder: '0', firstDigit: '9', secondDigit: '3', thirdDigit: '8', fourthDigit: '1', firstButton: 'T', secondButton: 'F', thirdButton: 'F', fourthButton: 'F', template: 'divisionFour' },
			...
			{ problemStatement: 'Solve: 82292 <span class=bigger>&divide;</span> 905.', instructions: 'Solve the problem.', divisor: '905', dividend: '82292', quotient: '90', remainder: '842', firstDigit: '8', secondDigit: '2', thirdDigit: '2', fourthDigit: '9', fifthDigit: '2', firstButton: 'F', secondButton: 'F', thirdButton: 'F', fourthButton: 'T', fifthButton: 'F', template: 'divisionFive' }
        ];
