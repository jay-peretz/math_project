...
angular.module('mathSkills').service('data3_2', ['dataUtils', function (dataUtils) {
    var desc = {
        ...
        data = [
			...
			{ problemStatement: '<table class=fraction><tr><td>x</td></tr><tr><td><hr></td></tr><tr><td>y</td></tr></table>', instructions: 'Set up the division problem by placing the dividend and the divisor in the proper places.', divisor: 'x', dividend: 'y', template: 'setupDivision' },
